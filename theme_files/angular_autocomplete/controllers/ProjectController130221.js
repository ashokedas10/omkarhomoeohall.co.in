		...
		function($scope,$rootScope,$http,$window,general_functions,$location)
		{
				...
				//$rootScope.current_form_report='grn_entry';
				 ...
				 console.log(data_save);
					...
					$scope.dtlist_view=function(indx)
					{
						...
						{
						var field_list=['id','product_id','batchno','mrp','disc_per',
						'rate','qnty','subtotal','exp_monyr','mfg_monyr','tax_ledger_id'];	
						}
			...
			// }
				...
				{		
						...
						if(searchelement=='qnty' && $rootScope.current_form_report=='invoice_entry' )
						{
