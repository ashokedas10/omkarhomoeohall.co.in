...
public function send_whatsup_sms()
{ 
		
		//FINAL CODE
		$source_mobileno="917834811114";
		$destination_mobileno="919804152658";
		$app_name="Transactions";
		$apikey="wbcnj43asaoqgecpyvijzekyozfrkjao";
		//$text_msg='This my test message';
		
		$text_msg='On Date-20.12.20 Ptax Expiry:wb123,W.B Tax:wb1234'.' |'.
				 'On Date-20.12.20 Ptax Expiry:wb123,W.B Tax:wb1234'.' |'.
				 'On Date-20.12.20 Ptax Expiry:wb123,W.B Tax:wb1234';
		...
		//echo urlencode(json_encode( $msg ));
	
		/*$payload = array(
			'channel' 		=>  'whatsapp',
			'source' 		=>  '917384811114',
			'destination' 	=>  '919804152658',
			'src.name' 		=>  'Transactions',			
			'message'		=> $msg
		);*/

		$payload="channel=whatsapp&source=".$source_mobileno."&destination=".$destination_mobileno."&src.name=".$app_name."&message=".urlencode(json_encode( $msg ))."";
		  ...
		  echo $response;
			...
			//2ND TYPE--working
				...
				if($send_status)
				{
					...
					$sendmsg='On Date-20.12.20 Ptax Expiry:wb123,W.B Tax:wb1234'.'<br>'.
					'On Date-20.12.20 Ptax Expiry:wb123,W.B Tax:wb1234'.'<br>'.
					'On Date-20.12.20 Ptax Expiry:wb123,W.B Tax:wb1234';
									
					$message = array('V Expiry:For the Month nov20',$sendmsg);  	
...
//http://sms.bulksmsmarg.com/rest/services/sendSMS/sendGroupSms?AUTH_KEY=25d15be0b4a717c984f31d1b70704f1b&message=message&senderId=TBTSIG&routeId=3&mobileNos=9804152658&smsContentType=english
