...
<div ng-app="Accounts" ng-controller="purchase_rtn" >
		  ...
		  <input type="hidden" id="tot_cash_discount"  name="tot_cash_discount" ng-model="tot_cash_discount" />
			...
			<div class="panel-body" >
				<div  class="form-row">	
				 ...
				 <tr>
					<td  align="center" colspan="6"  class="activeTR"><strong>PURCHASE RETURN ENTRY</strong></td> 
					...
					<tr>
						...
						ng-change="search('tbl_party_id_name')" class="form-control" autocomplete="off"/>
						</td>
						<td  >Comment</td> 
				 ...
				 <table class="table table-bordered table-striped" >
				  ...
				  <tr><td class="srscell-head-divider" colspan="7"><span class="style2 activeTR">{{savemsg}}</span>
					...
					<tr>
						...
						ng-change="search('product_id_name')" class="form-control" ng-keypress="mainOperation($event,7)" autocomplete="off"/>						
						 </td> 
						...
						<td width="144"> 
						  ...
						  <input id="8" autofocus type="text" 
									 ...
									 class="form-control" ng-keypress="mainOperation($event,8)" autocomplete="off"/>	
						 </td> 
						 <td  align="left"> 
	...
	<table class="table table-bordered table-striped" >
			   ...
			   <tbody>
					...
					<tr ng-repeat="dtl in ListOfTransactions">
						...
						<td  align="left"><button class="btn-block btn-info" ng-click="delete_invoice(dtl.id_header)"
