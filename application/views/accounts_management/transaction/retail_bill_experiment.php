...
<div ng-controller="retail_bill_experiment" class="panel panel-primary" id="myBody" onchange = "shortcut()" >
	...
	<tr>		
		...
		<!--{{product_rate_mstr_array[FormInputArray[0]['header'][1]['fields'][0]['product_group_id']['Inputvalue_id']][FormInputArray[0]['header'][1]['fields'][0]['potency_id']['Inputvalue_id']][FormInputArray[0]['header'][1]['fields'][0]['pack_id']['Inputvalue_id']]}}
		
		<br />-->
			
	<!--	{{FormInputArray[0]['header'][1]['fields'][0]['product_group_id']['Inputvalue_id']}}-->
...
<tr>
		<td  align="left" class="input_field_height">{{get_field_name(0,'LabelName','invoice_no')}}</td> 
		<td  align="left" class="input_field_height">{{get_field_name(0,'LabelName','invoice_date')}}</td> 
		<td  align="left" class="input_field_height">{{get_field_name(0,'LabelName','patient_name')}}</td> 
		<td  align="left" class="input_field_height">{{get_field_name(0,'LabelName','patient_address')}}</td> 
		<td  align="left" class="input_field_height">{{get_field_name(0,'LabelName','doctor_ledger_id')}}</td> 
...
class="form-control input_field_height" onfocus="this.select();" onmouseup="return false;"   readonly=""/>
...
class="form-control input_field_height" onfocus="this.select();" onmouseup="return false;"  />
</td>
