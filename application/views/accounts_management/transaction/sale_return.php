...
<div ng-app="Accounts"   >
	...
	<div class="panel panel-primary" ng-controller="sale_return" ng-click="hideMenu($event)" id="myBody" onchange = "shortcut()">
		...
		<input type="hidden" id="tot_cash_discount"  name="tot_cash_discount" ng-model="tot_cash_discount" />
			...
			<table class="table table-bordered table-striped" >
			<tr>
					<td  align="center" colspan="2"  class="activeTR"><strong>SALE RETURN ENTRY</strong></td> 
					 ...
					 Print POS(<strong>F11</strong>) |
							...
							<tr><!---->
								...
								<td>		 
										...
										ng-focus="search('tbl_party_id_name')" ng-change="search('tbl_party_id_name')" 
										  class="form-control" ng-keypress="mainOperation($event,2)" autocomplete="off"/>	
							  </td> 
								  ...
								  <td>
									...
									ng-model="BILL_TYPE" ng-focus="search('BILL_TYPE')"
									ng-change="search('BILL_TYPE')" ng-keypress="mainOperation($event,3)" class="form-control" autocomplete="off" />
							   </td> 
		   						...
		   						<td>
									...
									ng-change="search('doctor_ledger_id_name')" ng-keypress="mainOperation($event,4)" class="form-control" autocomplete="off"/>
							   </td>
							   ...
							   <td>
									...
									ng-keydown="checkKeyDown($event)" ng-keyup="checkKeyUp($event)" 
									ng-model="hq_id_name" 
									ng-change="search('hq_id_name')" ng-keypress="mainOperation($event,5)" class="form-control" autocomplete="off"/>
							...
							<tr>
							  ...
							  <td  align="left" ><input type="text" id="8" class="form-control" name="barcode" ng-model="barcode" 
								...
								<!-- <input id="10" autofocus type="text" 
								 ...
								 ng-model="batchno" ng-change="search('batchno')" 
								 class="form-control" ng-keypress="mainOperation($event,10)" autocomplete="off"/></td> 
