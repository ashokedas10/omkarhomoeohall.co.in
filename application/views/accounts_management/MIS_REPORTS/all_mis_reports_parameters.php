...
<?php if($REPORT_NAME=='PRODUCT_GROUP_WISE_LISTING' ){ ?> 
...
<?php if($REPORT_NAME=='DOCTOR_COMMISSION_SUMMARY' || $REPORT_NAME=='DOCTOR_COMMISSION_DETAILS'
 ...
 || $REPORT_NAME=='PURCHASE_REGISTER' || $REPORT_NAME=='SALE_REGISTER' || $REPORT_NAME=='DOCTOR_PRESCRIPTIONS'  ){ ?> 
