				...
				<!--<td width="40" colspan="6">--</td>-->
					 ...
					 <?php 
						...
						?>	
							...
							<?php /*?> <td width="40"align="right" ><?php echo $trading_rs[$trading_cnt]['destination'] ?></td>	<?php */?>					
							...
							<?php /*?> <td width="40"align="right" ><?php echo $trading_rs[$trading_cnt]['grand_total'] ?></td>	<?php */?>
							 </tr>	
					<?php }} ?>
							<tr  style="background-color:#CC6633">
