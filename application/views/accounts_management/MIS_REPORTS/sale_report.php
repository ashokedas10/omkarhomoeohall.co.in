...
<table   class="table table-bordered table-striped">
	    <thead>
		 ...
		 <tr><td colspan="8" align="center" ><?php  echo 'B2B Party Sale Report from '.$fromdate.' to '.$todate; ?></td></tr>
	   ...
	   <tbody>
			...
			<tr>
				...
				<td colspan="15" align="center">GST DETAILS</td>
				<td width="58" >Total GST</td>
			...
			?>
			 <tr>
				...
				<td width="17" ><?php echo $invoices[$group2]['totvatamt']; ?></td>
				<td width="17" ><?php echo $invoices[$group2]['grandtot']; ?></td>
				<td width="17" >
				<?php echo $tot_paid=$this->accounts_model->bill_wise_outstanding('invoice_summary',$invoices[$group2]['id'],'MINUS');
				 ?></td>
				<td width="17" ><?php echo $invoices[$group2]['grandtot']-$tot_paid; ?></td>
...
<table   class="table table-bordered table-striped">
	    <thead>
		 ...
		 <tr><td colspan="8" align="center" ><?php  echo 'B2C Party Sale Report from '.$fromdate.' to '.$todate; ?></td></tr>
