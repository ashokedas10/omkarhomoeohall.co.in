...
<!--CURRENT TEMPLATE PARTS-->
 ...
 <link rel="stylesheet" href="<?php echo BASE_PATH_ADMIN;?>theme_files/bootstrap/css/bootstrap.min.css">
    ...
    <?php /*?><link rel="stylesheet" href=<?php echo BASE_PATH_ADMIN;?>theme_files/"plugins/iCheck/flat/blue.css"><?php */?>
...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini">
	...
	<div class="wrapper" >
     ...
     <div class="content-wrapper">
	  ...
	  <footer class="main-footer">
		...
		Copyright &copy; 2020 <a href="#"><?php echo $NAME ?></a>.</strong> 
 ...
 <!-- jQuery 2.1.4 -->
  ...
  <?php /*?>  <script src="<?php echo BASE_PATH_ADMIN;?>theme_files/plugins/jQuery/jQuery-2.1.4.min.js"></script><?php */?>
	...
	<link rel="stylesheet" href="https://bossanova.uk/jsuites/v2/jsuites.css" type="text/css">
		...
		<script src="<?php echo BASE_PATH_ADMIN;?>theme_files/angular_autocomplete/controllers/jquery.maskedinput-1.2.2-co.min.js"></script>
		<script src="<?php echo BASE_PATH_ADMIN;?>theme_files/angular_autocomplete/controllers/general_services.js"></script>
		<script src="<?php echo BASE_PATH_ADMIN;?>theme_files/angular_autocomplete/controllers/ProjectController.js">
