...
<h2><span class="tcat">Upload Data</span></h2>
<?php echo date("Y-m-d", 42015);?>
	...
	<td width="127" class="srscell-head-lft">Select</td>
		...
		<td class="srscell-body">
		 ...
		 <select id="SettingName" class="form-control select2"   name="SettingName" >
             ...
             <option value="PRODUCT_MASTER" selected="selected">PRODUCT_MASTER</option>	
 			<option value="patient_upload" selected="selected">Patient Uplod</option>	
			 
			<option value="DOCTOR_UPLOAD" selected="selected">DOCTOR_UPLOAD</option>	
			 <option value="party_upload" selected="selected">party_upload</option>	
			 
			 <option value="PRODUCT_BATCH_DATA" selected="selected">PRODUCT_BATCH_DATA</option>	
