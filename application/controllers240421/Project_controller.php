...
{		
		...
		// 	echo '</pre>';
				...
				//	echo $absolute_path=FCPATH.'sessions/';
			// 	echo $session_id = session_id();;
			// 	$path=BASEPATH.'sessions/ci_session'.$session_id;
		  // 	echo	$absolute_path=FCPATH.'sessions/ci_session'.$session_id;
		...
		//echo	$path=BASE_PATH_ADMIN.'sessions';
		//echo	$map = directory_map($path,1);
