...
ng-init="initarray('RECEIVE')" id="myBody">


<div class="panel panel-primary" >	
	 <div class="panel-body" align="center" style="background-color:#99CC00">
	  <span class="blink_me style2">RECEIVE ENTRY</span><br />
...
<form id="Transaction_form" name="Transaction_form" >
			...
			<div class="panel-body" > 
				...
				<div ng-if="FormInputArray[i].detailtype === 'STAFF_DRIVERS'">
				  ...
				  [0,FormInputArray[i]['details'].length-1] | toRange">
                    <td>
						...
						ng-model="FormInputArray[i]['details'][bil].bill_id">						
							...
							<input type="text" id="{{'BILL_INSTRUMENT_NO-'+i+bil}}"
							ng-model="FormInputArray[i]['details'][bil].BILL_INSTRUMENT_NO"
							ng-keydown="checkKeyDown($event)" 
							ng-keyup="checkKeyUp($event)" 
							 select-on-click 
							placeholder="Select" 
							ng-keypress="mainOperation($event,'BILL_INSTRUMENT_NO',i,bil,'searchItem',19)" 
							class="form-control" style="text-align:left;">
					</td>
				...
				<div ng-if="FormInputArray[i].detailtype === 'SALE_BILL'">
                    ...
                    <td>
						...
						ng-model="FormInputArray[i]['details'][bil].bill_id">						
							...
							ng-keyup="checkKeyUp($event)" 
							 select-on-click 
							placeholder="Select" 
							ng-keypress="mainOperation($event,'BILL_INSTRUMENT_NO',i,bil,'searchItem',0)" 
							class="form-control" style="text-align:left;">
					</td>
				...
				<div  class="form-row" >	 
						...
						ng-click="get_set_value('','RECEIVE_VOUCHER','DRCRCHECKING')">Submit</button>	
				</div>	
