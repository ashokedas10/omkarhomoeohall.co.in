...
onsubmit="return validateForm()">
		...
		<input type="hidden" value="<?php echo $id_header; ?>"   name="id_header" id="id_header">

		<input type="hidden" value="<?php echo $id_detail; ?>"  name="id_detail" id="id_detail">
		...
		<input type="hidden" value=""  name="LogoType" id="LogoType">	
		 ...
		 <table  class="srstable" style="width:100%">
		   ...
		   <tr>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 1- Name</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields_name; ?>"  name="DataFields_name"  style="width:1000px;" 
		   ...
		   <tr>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 1</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields; ?>"  name="DataFields"  style="width:1000px;" 
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 2-Name</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields2_name; ?>"  name="DataFields2_name"  style="width:1000px;" autocomplete="off"  />		     </td>
		   ...
		   <tr>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 2</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields2; ?>"  name="DataFields2"  style="width:1000px;" autocomplete="off"  />	    		 			</td>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 3-Name</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields3_name; ?>"  name="DataFields3_name"  style="width:1000px;" 
		   ...
		   <tr>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 3</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields3; ?>"  name="DataFields3"  style="width:1000px;" autocomplete="off"  />		    		 </td>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 4-Name</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields4_name; ?>"  name="DataFields4_name"  style="width:1000px;"
		   ...
		   <tr>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 4</td>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $DataFields4; ?>"  name="DataFields4"  style="width:1000px;" autocomplete="off"  />		     </td>
		   ...
		   <tr>
		    ...
		    <td  width="10%" class="srscell-head-lft">Data Fields 5</td>

             <td class="srscell-body" colspan="3">

			   <input type="text" id="DataFields5" 

			  value="<?php echo $DataFields5; ?>"  name="DataFields5"  style="width:1000px;" 
		    ...
		    <tr>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $GridHeader_name; ?>"  name="GridHeader_name"  style="width:1000px;" autocomplete="off" />		     </td>
		    ...
		    <tr>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $GridHeader; ?>"  name="GridHeader"  style="width:1000px;"  autocomplete="off" />		     </td>
		   ...
		   <tr>
             ...
             <td class="srscell-body" colspan="3">
			  ...
			  value="<?php echo $WhereCondition; ?>"  name="WhereCondition" style="width:1000px;" />		     </td>
